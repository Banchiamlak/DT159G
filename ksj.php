...
<meta> 
  ...
  var markers = [
    ...
    }, 
    {
      ...
      content: '<h1>Mittuniversitet Sundsvall<h1>'
    },
    {
    ...
    }, 
    {
      ...
      content: '<h1>Kungliga tekniska högskolan<h1>'
    }, 
    {
  ...
  if(props.content){
    ...
    <!-- AIzaSyAtxqP_w9x09G9A5t2sA6XKx7p8L7H9tjo -->
    <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAtxqP_w9x09G9A5t2sA6XKx7p8L7H9tjo&callback=initMap"  
      Async 
    ></script> 
  </body>
</html>